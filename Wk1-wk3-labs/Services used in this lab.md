...
Copy the LinuxSessionUrl value that is listed to the left of these instructions, and paste it into a new browser tab to connect to the kiosk server.
...
nano upload.sh
Copy the following information, and paste it into the upload.sh file in nano text editor:
